...
const menuItems = [
  {
    title: "MENU",
    items: [
      { icon: "/home.png", label: "Home", href: "ROLE_HOME", visible: ["admin", "teacher", "student", "parent"] },
...
// Role is passed from the server layout — no client-side cookie decoding needed
    ...
    <div className="mt-4 text-sm">
      ...
      <div className="mt-4 border-t pt-3">
        <button
          ...
          className="flex items-center gap-2 text-gray-600 py-2 px-2 rounded-lg hover:bg-red-50 hover:text-red-600 transition-colors w-full"
        >
